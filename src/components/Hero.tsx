        ...
        <div className="space-y-8">
          ...
          <div className="flex flex-wrap gap-4 items-center">
            ...
            <PDFDownloadLink
              ...
              className="px-8 py-4 border border-outline-variant border-opacity-20 text-primary rounded-full font-medium transition-all duration-300 inline-block hover:bg-surface-container-low"
            >
              {({ loading, error }) => {
                if (error) console.error("PDF Component Error:", error);
                return loading ? 'Gerando PDF...' : hero.secondaryCta.label;
              }}
            </PDFDownloadLink>
